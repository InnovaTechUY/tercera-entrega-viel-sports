...
rounded-lg shadow-lg">
  ...
  <form method="POST" action=""> <!--Agregar al action la ruta
que devuelve el error en caso de que ya exista un usuario registrado
con ese email (hay un metodo que retorna el error)-->
    @csrf
